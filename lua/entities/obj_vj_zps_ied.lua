...
ENT.SoundTbl_OnCollide = {
    "darkborn/zps/weapons/explosives/ied/ied_drop-01.wav",
    "darkborn/zps/weapons/explosives/ied/ied_drop-02.wav",
    "darkborn/zps/weapons/explosives/ied/ied_drop-03.wav",
    "darkborn/zps/weapons/explosives/ied/ied_drop-04.wav",
    "darkborn/zps/weapons/explosives/ied/ied_drop-05.wav"
}
-- Custom
ENT.IED_ArmT = 2
ENT.IED_Armed = false
...
function ENT:Detonate()
    ...
    timer.Simple(SoundDuration("darkborn/zps/weapons/explosives/ied/ied_alarm.wav"), function()
